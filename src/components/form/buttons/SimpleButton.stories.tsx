...
const meta: Meta<typeof SimpleButton> = {
  title: 'Forms/Buttons/Simple button',
...
export const ElementLabel: Story = {
  args: {
    id: 'buttonTest2',
    label: <strong>Label <em>with</em> markup</strong>
  }
};

export const LabelWithLeftIcon: Story = {
  args: {
    id: 'buttonTest3',
    label: 'Text',
    leftIcon: { icon: 'quill' }
...
export const LabelWithRightIcon: Story = {
  args: {
    id: 'buttonTest4',
    label: 'Text',
    rightIcon: { icon: 'quill' }
  }
};

export const LabelWithBothIcons: Story = {
  args: {
    id: 'buttonTest5',
    label: 'Text',
    leftIcon: { icon: 'quill' },
...
export const BabySlothButton: Story = {
  args: {
    hideLabel: true,
    children: <span style={
      {
